...
export const STORIES = [
  {
    ...
    region: "animals",
    scenes: [
      { emoji: "🦁", mood: "calm", text: "كان فيه أسد كبير وقلبه طيّب عايش في غابة خضرا حلوة." },
      { emoji: "🐭", mood: "scared", text: "وفجأة... سمِع صوت صغيّر بيرتعش! فأر صغيّر خايف متخبّي تحت الشجرة." },
      { emoji: "🤝", mood: "happy", text: "الأسد بصّ له وضحك وقال بحنان: متخفش يا صغيري، أنا صاحبك." },
      { emoji: "🧀", mood: "happy", text: "الفأر فرِح وجاب له أحلى قطعة جبنة وقال: شكراً يا صاحبي!" },
      { emoji: "❤️", mood: "wonder", text: "ومن اليوم ده، بقوا أحسن صاحبين في الغابة كلها." },
    ],
  },
  {
    id: "apple-tree",
  ...
  },
  {
    ...
    region: "values",
    scenes: [
      { emoji: "👩", mood: "sad", text: "كانت ماما ليلى تعبانة وهي بتجهّز الأكل." },
      { emoji: "🤔", mood: "calm", text: "فليلى وقفت تفكّر: أساعد ماما الحبيبة إزاي؟" },
      { emoji: "🍽️", mood: "happy", text: "وبكل حب، رصّت الأطباق على السفرة بنفسها." },
      { emoji: "🥰", mood: "happy", text: "فماما ابتسمت ابتسامة كبيرة وحضنت ليلى." },
      { emoji: "❤️", mood: "wonder", text: "فمساعدة الأهل بتملا البيت حب ودفا." },
    ],
  },
  {
    id: "honesty",
  ...
  },
  {
    ...
    region: "values",
    scenes: [
      { emoji: "🍎", mood: "happy", text: "كان مع نور تفاحتين حُمر لذاذ." },
      { emoji: "👦", mood: "sad", text: "بس شافت صاحبها قاعد جعان من غير أكل..." },
      { emoji: "🤲", mood: "happy", text: "ففكّرت نور شوية... وبعدين دّت له تفاحة وقاسمته." },
      { emoji: "😊", mood: "happy", text: "فأكلوا مع بعض وضحكوا بسعادة كبيرة." },
  ...
  },
  {
    ...
    region: "jobs",
    scenes: [
      { emoji: "🤒", mood: "sad", text: "الأرنب الصغيّر جاله برد ورشح... فبقى زعلان." },
      { emoji: "👩‍⚕️", mood: "calm", text: "فراح للدكتورة الطيّبة في عيادتها النضيفة." },
      { emoji: "🩺", mood: "calm", text: "كشفت عليه بلطف وحنان، وادّته دوا طعمه حلو." },
      { emoji: "🥕", mood: "happy", text: "وقالت بابتسامة: كُل كويس ونام بدري يا صغيري." },
      { emoji: "😄", mood: "happy", text: "وبعد يومين... الأرنب خِفّ خالص ورجع ينطّ ويلعب!" },
    ],
  },
  {
    id: "little-car",
