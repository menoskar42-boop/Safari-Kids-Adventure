...
global.document = {
  ...
  createElementNS: () => makeEl(), // دعم عناصر SVG في الاختبار
...
const cases = [
  ...
  ["dotToDot", "../js/games/dotdot.js", "renderDotToDot", { regionId: "numbers", regionIndex: 0, title: "t" }],
  ...
  ["readMatch", "../js/games/readmatch.js", "renderReadMatch", { regionId: "animals", regionIndex: 4, datasetKey: "animals", title: "t" }],
  ["challenge", "../js/games/challenge.js", "renderChallenge", {}],
  ["spinWheel", "../js/screens/spinwheel.js", "renderSpinWheel", {}],
  ["badges", "../js/screens/badges.js", "renderBadges", {}],
  ["funHub", "../js/screens/funHub.js", "renderFunHub", {}],
